...
import com.aliyun.darabonba.logging.ClientLogger;
...
public class Model {
    private static final ClientLogger logger = new ClientLogger(Model.class);
    ...
    private static Object buildObject(Object o, Class self, Type subType, String objectName) {
        ...
        if (Map.class.isAssignableFrom(self) && Map.class.isAssignableFrom(valueClass)) {
            ...
            try {
                return Model.toModel((Map<String, Object>) o, (Model) self.newInstance());
            } catch (Exception e) {
                throw new TeaException(e.getMessage(), e);
            }
        } else {
    ...
    public static <T extends Model> T toModel(Map<String, ?> map, T model) {
        T result = model;
    ...
    @SuppressWarnings("unchecked")
    private static <T extends Model> T setTeaModelField(T model, Field field, Object value, String objectName, boolean userBuild) {
        try {
            ...
            if (Model.class.isAssignableFrom(clazz)) {
                ...
                if (userBuild) {
                    ...
                    field.set(result, Model.toModel((Map<String, Object>) resultValue, (Model) data));
                } else {
    ...
    @SuppressWarnings("unchecked")
    public static <T extends Model> T build(Map<String, ?> map, T model) {
        T result = model;
    ...
    public static Map<String, Object> buildMap(Model teaModel) {
        if (null == teaModel) {
            return null;
        } else {
    ...
    public static void validateParams(Model teaModel, String paramName) {
        if (null == teaModel) {
